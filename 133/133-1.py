...
# Данные измерений: для каждого набора указаны диаметр (мм), длина (см),
# список значений ΔP в виде "число*коэф" и соответствующий расход Q (л/мин)
data = {
    1: {'d': 3.95, 'l': 50,
...
def process_set(n):
    ...
    return P_sorted, Q_sorted, P_cr, P_lam, Q_lam, slope, intercept, d_mm, l_cm
